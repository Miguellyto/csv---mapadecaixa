...
def UploadAction():
    ...
    # LinhasEmBranco = mapadecaixa[mapadecaixa['DEBITO'].isnull()]
...
def hello():
    # tkinter.messagebox.showinfo(LinhasEmBranco)
...
# texto = Label(root, text=LinhasEmBranco)
# texto.grid(column=1, row=7, padx=40, pady=40)
